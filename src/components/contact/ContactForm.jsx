            ...
            <div className="container grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.5 }} className='flex justify-center items-center'>
                    <form onSubmit={handleSubmit} className='bg-primary/45 p-8 rounded-xl w-full max-w-lg'>
                        ...
                        <div className='mb-4'>
                            <label className='block text-white/30' htmlFor="name">Nom</label>
                        ...
                        <div className='mb-4'>
                            <label className='block text-white/30' htmlFor="email">Adresse e-mail</label>
                        ...
                        <button type='submit' className='primary-btn my-6 mr-6 inline-block'>Envoyer le message</button>
                    </form>
                </motion.div>
                {/* Image section */}
