...
const Services = [
  {
    ...
    description:
      "Création de descriptions captivantes et optimisées pour le SEO, mettant en valeur les caractéristiques et avantages des produits. Ce service aide à attirer l'attention des consommateurs, à améliorer la visibilité sur les moteurs de recherche et à encourager les décisions d'achat sur les sites e-commerce.",
    image: "https://picsum.photos/200/300",
    icon: <FaCube className="text-4xl" />,
    bgColor: "bg-blue-500/70",
  },
  {
    name: "Rédaction d'articles optimisés pour le web",
    description:
  ...
  {
    name: "Optimisation des contenus avec 1.fr",
    description:
  ...
  {
    name: "Rédaction d'articles de blog optimisés",
    description:
  ...
  {
    name: "Optimisation des balises meta",
    description:
